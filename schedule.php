...
<head>
    <meta charset="utf-8">
    <title>CrossFit Hayden - Schedule</title>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-title text-center">
                            <h2 class="main-title">Box Schedule</h2>

                            <h3 class="sub-title">There Are No Excuses!</h3>
        ...
        <div class="row">
          <div class="col-lg-offset-1 col-lg-10">
            ...
            <div class="mobile-only text-warning">
              <p>
                Drag to scroll the schedule <i class="fa fa-arrow-left"></i> or <i class="fa fa-arrow-right"></i>
              </p>
            </div>
